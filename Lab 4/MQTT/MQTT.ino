...
void loop()
{
   ...
   SERIAL_PORT.print("predicted idle: " +  String(predictedidleP) + " and predicted non-idle: " + String(predictedidleN));
}
...
bool predicted_idle(ICM_20948_AGMT_t agmt){
  bool predicted = true;
  if((16000<agmt.acc.axes.z<17000) && (-350>agmt.acc.axes.y>-650) && (-800>agmt.acc.axes.x>-1200)){
    predicted = true;
  }else{
    predicted = false;
  }
